...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small><?php echo $penguji2; ?> (Penguji 2)</small>
      </h1>
    </section>
            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" action="<?php echo base_url() ?>dosen/penilaian3" method="post" id="penilaian" role="form">	
                    	<div class="box-body">
                                <div class="col-md-12">                                
                            ...
                            <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="dosen3">Nama Penguji</label>
                                        <select class="form-control" id="dosen3" name="dosen3" disabled="true">
                                            <option value="0">Select Penguji 2</option>
                                            <?php
                                            if(!empty($dosens3))
                                            {
                                                foreach ($dosens3 as $ds3)
                                                {
                                                    ?>
                                                    <option value="<?php echo $ds3->penguji2Id; ?>" <?php if($ds3->penguji2Id == $penguji2Id) {echo "selected=selected";} ?>><?php echo $ds3->penguji2 ?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
                                ...
                                <div class="col-md-12">                                
                                    <div class="form-group">
                                        ...
                                        <input type="textfield" class="form-control" id="status" placeholder="Full Name" name="status" value="<?php echo $status5; ?>" maxlength="128" readonly>
					    ...
					    <div class="box-body">
					        <div class="form-group">
					        <label class="col-sm-12 ">b.	Materi Matematika (bobot 5) *</label>
					            <div class="col-sm-12">
