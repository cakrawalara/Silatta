<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> List Seminar Proposal
        <small></small>
      </h1>
    </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <form action="<?php echo base_url() ?>listing/listSeminar" method="POST" id="searchList">
                  ...
                  <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                          ...
                          <a class="btn btn-sm btn-info" href="<?php echo base_url().'listing/edit2/'.$record->userId; ?>"><i class="fa fa-pencil"></i></a>
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        jQuery('ul.pagination li a').click(function (e) {
            ...
            jQuery("#searchList").attr("action", baseURL + "listSeminar/" + value);
