...
if(!empty($userInfo))
{
    foreach ($userInfo as $uf)
    {
        ...
        $dosen2 = $uf->dosen2;
        $statusSidang2 = $uf->statusSidang2;
    }
}
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-university"></i> Penilaian Sidang Skripsi
        <small><?php echo $dosen2; ?> (Penguji 1)</small>
      </h1>
    </section>
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Penilaian Penguji 1</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    
                    <form role="form" action="<?php echo base_url() ?>dosen/penilaian2" method="post" id="penilaian" role="form">	
                    	<div class="box-body">
                                <div class="col-md-12">                                
                            ...
                            <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="dosen2">Nama Penguji</label>
                                ...
                                <div class="col-md-12">                                
                                    <div class="form-group">
                                        ...
                                        <input type="textfield" class="form-control" id="status" placeholder="Full Name" name="status" value="<?php echo $statusSidang2; ?>" maxlength="128" readonly>
