...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Edit Periode Kompre
            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" action="<?php echo base_url() ?>daftarUjianKompre/editPeriodeProses" method="post" id="editUser" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        <label for="idPeriodeKompre">Id Periode</label>
                                        <input type="text" class="form-control" id="idPeriodeKompre" placeholder="Full Name" name="idPeriodeKompre" value="<?php echo $idPeriodeKompre; ?>" >
