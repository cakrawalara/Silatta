                            ...
                            <div class="row">
                               ...
                               <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="tanggalBimbingan4" placeholder="" name="tanggalBimbingan4" value="<?php echo $tanggalBimbingan4; ?>" disabled>
                                       <input type="hidden" value="<?php echo $logSidang2Id; ?>" name="logSidang2Id" id="logSidang2Id" />
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="logBimbingan2Sidang">Log Bimbingan</label> <br><br>
                                        <?php echo $logBimbingan2Sidang; ?>
