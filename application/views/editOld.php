                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="reviewer" name="reviewer" ">
                                            <option value="0">Belum Ada Reviewer</option>
                                            <?php
                                            if(!empty($reviewers))
                                            {
                                                ...
                                                {
                                                    ?>
                                                    <option value="<?php echo $ds->reviewerId; ?>" <?php if($ds->reviewerId == $reviewerId) {echo "selected=selected";} ?>><?php echo $ds->reviewer ?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="moderator" name="moderator" ">
                                            <option value="0">Belum Ada Moderator</option>
                                            <?php
                                            if(!empty($moderators))
                                            {
                                                foreach ($moderators as $ds)
                                                {
                                                    ?>
                                                    <option value="<?php echo $ds->moderatorId; ?>" <?php if($ds->moderatorId == $moderatorId) {echo "selected=selected";} ?>><?php echo $ds->moderator ?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="penguji2" name="penguji2" ">
                                            <option value="0">Belum Ada Penguji 2</option>
                                            <?php
                                            if(!empty($pengujis))
                                            {
                                                foreach ($pengujis as $ds)
                                                {
                                                    ?>
                                                    <option value="<?php echo $ds->penguji2Id; ?>" <?php if($ds->penguji2Id == $penguji2Id) {echo "selected=selected";} ?>><?php echo $ds->penguji2 ?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
